...
export const MODEL_REQUEST_INFO = {
  ...
  // GitHub Models
  "github-gpt4o":       { providerName: "GitHub Models", endpoint: "models.inference.ai.azure.com/chat/completions", modelId: "gpt-4o", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "GPT-4o · Vision-capable" },
  "github-gpt4o-mini":  { providerName: "GitHub Models", endpoint: "models.inference.ai.azure.com/chat/completions", modelId: "gpt-4o-mini", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "GPT-4o Mini · Vision-capable · Fast" },
  "github-gpt5":        { providerName: "GitHub Models", endpoint: "models.inference.ai.azure.com/chat/completions", modelId: "gpt-5", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "GPT-5 · Vision-capable · Flagship" },
  "github-gpt5-mini":   { providerName: "GitHub Models", endpoint: "models.inference.ai.azure.com/chat/completions", modelId: "gpt-5-mini", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "GPT-5 Mini · Vision-capable" },
  "github-gpt5-nano":   { providerName: "GitHub Models", endpoint: "models.inference.ai.azure.com/chat/completions", modelId: "gpt-5-nano", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "GPT-5 Nano · Ultra-low latency" },
  "github-o4-mini":     { providerName: "GitHub Models", endpoint: "models.inference.ai.azure.com/chat/completions", modelId: "o4-mini", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "o4-mini · Reasoning" },
  "github-o3-mini":     { providerName: "GitHub Models", endpoint: "models.inference.ai.azure.com/chat/completions", modelId: "o3-mini", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "o3-mini · Reasoning" },
  "github-phi4":        { providerName: "GitHub Models", endpoint: "models.inference.ai.azure.com/chat/completions", modelId: "Phi-4", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "Phi-4 · Vision-capable · Compact" },
  "github-phi4-mm":     { providerName: "GitHub Models", endpoint: "models.inference.ai.azure.com/chat/completions", modelId: "Phi-4-multimodal-instruct", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "Phi-4 Multimodal · Vision + Audio" },
  "github-phi4-mini":   { providerName: "GitHub Models", endpoint: "models.inference.ai.azure.com/chat/completions", modelId: "Phi-4-mini-instruct", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "Phi-4 Mini · 3.8B · Very fast" },
  "github-llama70":     { providerName: "GitHub Models", endpoint: "models.inference.ai.azure.com/chat/completions", modelId: "Meta-Llama-3.3-70B-Instruct", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "Llama 3.3 70B · Open-source" },
};
