...
export const MODEL_REQUEST_INFO = {
  ...
  "huggingface":        { providerName: "HuggingFace Inference", endpoint: "router.huggingface.co/v1/chat/completions", modelId: "Qwen/Qwen2.5-72B-Instruct", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "Falls back through: Mistral-Nemo → DeepSeek-R1" },
  ...
  "cerebras-qwen235":   { providerName: "Cerebras", endpoint: "api.cerebras.ai/v1/chat/completions", modelId: "qwen-3-235b-a22b-instruct-2507", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "Qwen 3 235B MoE on Cerebras inference" },
  // NVIDIA NIM
