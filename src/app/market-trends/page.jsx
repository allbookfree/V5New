...
const MARKETPLACE_HOOKS = [
  ...
  { id: "depositphotos", name: "Depositphotos", logo: "🗂️", url: "https://depositphotos.com/popular.html", tip: { en: "Popular page covers photo + vector + video bestsellers in one feed.", bn: "Popular পেজে photo + vector + video বেস্টসেলার একসাথে।" } },
  ...
  { id: "pixta", name: "Pixta", logo: "🌏", url: "https://www.pixtastock.com/ranking", tip: { en: "Ranking page is Pixta's official top-seller chart — strong signal for Asian demand.", bn: "Ranking পেজ Pixta-এর অফিসিয়াল টপ-সেলার চার্ট — এশিয়ান চাহিদার শক্ত ইঙ্গিত।" } },
  ...
  { id: "wirestock", name: "Wirestock", logo: "🔌", url: "https://wirestock.io/popular", tip: { en: "Popular feed + the 'Active Challenges' page show what curators are actively buying right now.", bn: "Popular ফিড + 'Active Challenges' পেজ — কিউরেটররা এখন কী কিনছে দেখুন।" } },
  ...
  { id: "society6", name: "Society6", logo: "🎨", url: "https://society6.com/promotion", tip: { en: "Promotions / featured artists pages preview what's about to go viral on POD.", bn: "Promotions / featured artists পেজ — POD-এ কোনটা ভাইরাল হবে আগেই দেখুন।" } },
  ...
  { id: "envato", name: "Envato Elements", logo: "🟢", url: "https://elements.envato.com/popular", tip: { en: "Popular sort across templates, graphics, and stock — refreshed daily.", bn: "Popular সাজানো — টেমপ্লেট, গ্রাফিক্স, স্টক — প্রতিদিন রিফ্রেশ।" } },
